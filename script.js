...
function showAdjustmentSummary(analysis, explanation) {
    ...
    if (standardTimetableContainer) {
        standardTimetableContainer.appendChild(summaryEl);
...
function addProgressAnalysisButton() {
    ...
    if (aiSection && !document.getElementById('analyze-progress-btn')) {
        ...
        aiSection.parentNode.insertBefore(analysisBtn, aiSection.nextSibling);
    }
}

// Helper function to get current UID
function getCurrentUID() {
    return currentUserId || 'default_user';
}
